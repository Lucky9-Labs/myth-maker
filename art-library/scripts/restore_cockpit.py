...
def restore(destination):
    manifest = json.loads((ROOT / 'art-library/releases/strokah-cockpit-mechanical-v1.json').read_text())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--destination', type=Path, default=ROOT / 'output/cockpit-mechanical')
