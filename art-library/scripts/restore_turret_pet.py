#!/usr/bin/env python3
"""Restore the pinned Nautiloid turret-pet authoring release."""
...
MANIFEST = ROOT / "art-library/releases/nautiloid-turret-pet-authoring-v1.json"
