...
def job(): return {'format':FORMAT,'run_id':'pilot-001','work_id':'cycle-001','attempt':1,'model':'gpt-6-astra','objective':'finish mech','state_summary':{},'evidence':[],'max_actions':4,'prepared_actions':[{'action_id':'review-arm','action_type':'review-3d','component_id':'upper-arm','summary':'review candidate','job':{'asset_id':'mech'}}]}
