...
const result = JSON.stringify({
  ...
  ...(benchmark ? { benchmark: {
    ...
    animationClipCount: benchmark.animation_clip_count,
    animationJointCount: benchmark.animation_joint_count,
    animationSamplesPerClip: benchmark.animation_samples_per_clip,
    sharedAnimationBufferBytes: benchmark.shared_animation_buffer_bytes,
    perAgentStateContractBytes: benchmark.per_agent_state_contract_bytes,
    visibleInstanceUploadBytes: benchmark.visible_instance_upload_bytes,
    poseUpdatesTotal: benchmark.pose_updates_total,
    cpuMainThreadMsAverage: benchmark.cpu_main_thread_ms_average,
    gcAllocatedBytesPerFrameAverage: benchmark.gc_allocated_bytes_per_frame_average,
